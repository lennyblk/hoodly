...
async function seed() {
  ...
  await db.collection("announcements").insertMany([
    ...
    { _id: new ObjectId(), authorId: uids.karim.toString(), neighbourhoodId: nids.belleville.toString(), title: "Montage de meubles", description: "Je monte vos meubles IKEA rapidement.", type: "offer", isPaid: false, points: 10, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "recurrent", days: ["Sam", "Dim"], startTime: "09:00", endTime: "18:00" }], serviceDetails: null, createdAt: past(3) },
    ...
    // Marais
    { _id: new ObjectId(), authorId: uids.frank.toString(), neighbourhoodId: nids.marais.toString(), title: "Cours de photo", description: "Photographe amateur, initiation à la photo numérique.", type: "offer", isPaid: false, points: 10, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "recurrent", days: ["Dim"], startTime: "10:00", endTime: "12:00" }], serviceDetails: null, createdAt: past(6) },
    { _id: new ObjectId(), authorId: uids.eve.toString(), neighbourhoodId: nids.marais.toString(), title: "Promenade de chien", description: "Disponible le matin pour promener votre chien.", type: "offer", isPaid: false, points: 5, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "recurrent", days: ["Lun", "Mar", "Mer", "Jeu", "Ven"], startTime: "07:00", endTime: "09:00" }], serviceDetails: null, createdAt: past(3) },
    ...
    // Bastille
    { _id: new ObjectId(), authorId: uids.grace.toString(), neighbourhoodId: nids.bastille.toString(), title: "Soutien scolaire", description: "Propose aide aux devoirs maths/français collège.", type: "offer", isPaid: false, points: 8, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "recurrent", days: ["Mer"], startTime: "14:00", endTime: "16:00" }], serviceDetails: null, createdAt: past(5) },
    { _id: new ObjectId(), authorId: uids.hugo.toString(), neighbourhoodId: nids.bastille.toString(), title: "Besoin de peintre", description: "Salon à repeindre, cherche coup de main.", type: "request", isPaid: true, points: 20, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "dates_exactes", dates: [future(7).toISOString().slice(0,10), future(8).toISOString().slice(0,10)] }], serviceDetails: null, createdAt: past(1) },
    ...
    // Republique
    { _id: new ObjectId(), authorId: uids.iris.toString(), neighbourhoodId: nids.republique.toString(), title: "Réparation vélo", description: "Je répare les vélos gratuitement le weekend.", type: "offer", isPaid: false, points: 10, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "recurrent", days: ["Sam", "Dim"], startTime: "10:00", endTime: "17:00" }], serviceDetails: null, createdAt: past(4) },
    ...
    // Bon Marche
    { _id: new ObjectId(), authorId: uids.sophie.toString(), neighbourhoodId: nids.bonmarche.toString(), title: "Cours de piano", description: "Pianiste classique, donne cours débutants/intermédiaires.", type: "offer", isPaid: true, points: 15, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "recurrent", days: ["Mar", "Ven"], startTime: "18:00", endTime: "19:00" }], serviceDetails: null, createdAt: past(5) },
    { _id: new ObjectId(), authorId: uids.remi.toString(), neighbourhoodId: nids.bonmarche.toString(), title: "Jardinage balcon", description: "Je peux vous aider à aménager votre balcon en jardin.", type: "offer", isPaid: false, points: 8, status: "open", acceptedBy: null, contractId: null, availabilities: [{ type: "recurrent", days: ["Sam"], startTime: "09:00", endTime: "12:00" }], serviceDetails: null, createdAt: past(3) },
