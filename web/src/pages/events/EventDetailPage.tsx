  ...
  return (
    <div className="flex flex-col h-full bg-creme">
      ...
      >
        <button
          onClick={() => navigate(-1)}
          className="absolute top-4 left-4 bg-white/80 backdrop-blur rounded-full w-9 h-9 flex items-center justify-center text-charbon hover:bg-white transition-colors text-lg shadow-sm z-10"
        >
          ←
        </button>
