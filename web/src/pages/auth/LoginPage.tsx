    ...
    <div className="flex h-full w-full">
      ...
      <div className="flex flex-1 items-center justify-center bg-creme px-6 py-10">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            <h2 className="font-heading text-3xl font-bold tracking-tight text-charbon">Bon retour</h2>
            <p className="mt-1.5 font-sans text-sm text-sable">Connectez-vous à votre compte</p>
          </div>
          ...
          <p className="mt-7 text-center font-sans text-sm text-sable">
            ...
            <Link to="/signup" className="font-semibold text-vert-moyen hover:underline">Créer un compte</Link>
          </p>
        </div>
      </div>
    </div>
